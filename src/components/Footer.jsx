    ...
    <footer className="mt-12 text-white bg-black">
      <div className="container max-w-screen-xl px-6 py-12 mx-auto">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-5">
          {/* العمود 1 */}
          <div>
            <h6 className="mb-4 text-2xl font-bold">Exclusive</h6>
            <p className="mb-2 font-medium">اشترك</p>
          ...
          {/* العمود 2 */}
          <div>
            <h6 className="mb-4 font-semibold">الدعم</h6>
          ...
          {/* العمود 5 */}
          <div>
            <h6 className="mb-4 font-semibold">تحميل التطبيق</h6>
            <p className="mb-4 text-sm text-gray-400">
              وفر 3 دولارات مع تطبيق جديد للمستخدمين فقط
            </p>
  ...
  >
    <svg width="30" height="30" fill="currentColor">
      ...
      <div className="py-4 text-sm text-center text-gray-500 bg-black border-t border-gray-800">
        © 2025 Exclusive. جميع الحقوق محفوظة
      </div>
    </footer>
  );
}
