  ...
  return (
    <section className="container px-4 mx-auto gap-14">
      ...
      <div className="flex flex-row items-center gap-4 mb-8 font-semibold md:text-lg">
        ...
        <span className="text-red-500">{t("MyProductsSection.title")}</span>
      </div>

      <div className="flex items-center md:justify-between md:mr-6 md:mb-4">
        <h1 className="text-2xl font-bold md:text-3xl">{t("MyProductsSection.subtitle")}</h1>
      </div>

      {/* المنتجات بدون scroll */}
      <div className="grid grid-cols-1 gap-6 mb-8 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-4">
      ...
      <div className="flex justify-center mt-4">
        ...
        >
          {t("MyProductsSection.view_all_products")}
        </Link>
      </div>
